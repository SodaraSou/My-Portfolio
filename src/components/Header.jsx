...
function Header() {
  return (
    <div className="w-full hidden md:block bg-daraBlack">
      <nav className="max-w-7xl lg:container mx-auto md:p-10 flex flex-col md:flex-row justify-center items-center md:justify-between space-y-5 md:space-y-0">
